...
if(VCPKG_TARGET_IS_MINGW)
    ...
    string(APPEND OPTIONS " --enable-w32threads --enable-d3d11va --enable-dxva2")
...
if(DEFINED ENV{FFMPEG_EXTRA_CONFIGURE_OPTIONS} AND NOT "$ENV{FFMPEG_EXTRA_CONFIGURE_OPTIONS}" STREQUAL "")
    message(STATUS "Applying extra FFmpeg configure options from environment")
    string(APPEND OPTIONS " $ENV{FFMPEG_EXTRA_CONFIGURE_OPTIONS}")
endif()
